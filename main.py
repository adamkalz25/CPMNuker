...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](07): Number Plates ~ FREE[/bold cyan]")
            ...
            console.print("[bold cyan](11): Unlock Paid Cars ~ FREE[/bold cyan]")
            console.print("[bold cyan](12): Unlock all Cars ~ FREE[/bold cyan]")
            console.print("[bold cyan](13): Unlock all Cars Siren ~ FREE[/bold cyan]")
            console.print("[bold cyan](14): Unlock w16 Engine ~ FREE[/bold cyan]")
            console.print("[bold cyan](15): Unlock All Horns ~ FREE[/bold cyan]")
            console.print("[bold cyan](16): Unlock Disable Damage ~ FREE[/bold cyan]")
            console.print("[bold cyan](17): Unlock Unlimited Fuel ~ FREE[/bold cyan]")
            console.print("[bold cyan](18): Unlock House 3 ~ FREE[/bold cyan]")
            console.print("[bold cyan](19): Unlock Smoke ~ FREE[/bold cyan]")
            console.print("[bold cyan](20): Change Race Wins ~ FREE[/bold cyan]")
            console.print("[bold cyan](21): Change Race Loses ~ FREE[/bold cyan]")
            console.print("[bold cyan](22): Clone Account ~ FREE[/bold cyan]")
